...
from HMW3_graphs import figure2
from HMW3_graphs import figure3
...
app.layout = html.Div([
	...
	html.Div([
	 	...
	 	html.Div([
	 		dcc.Graph(id='f',figure=figure)], className='six columns'),
	 		], className="row"),
	#row2
	html.Div([
		...
		html.Div([
			dcc.Graph(id='f1',figure=figure1)], className='six columns'),
	 		], className="row"),
	...
	html.Div([
		...
		html.Div([
			dcc.Graph(id='f2',figure=figure2)], className='six columns'),
	 		
	 	html.Div([
			dcc.Graph(id='f3',figure=figure3)], className='two columns')
	 		], className="row"),
	#row4
	html.Div([
		...
		html.Div([
			dcc.Graph(id='f4',figure=figure4)], className='eight columns'),
	 		], className="row")        
